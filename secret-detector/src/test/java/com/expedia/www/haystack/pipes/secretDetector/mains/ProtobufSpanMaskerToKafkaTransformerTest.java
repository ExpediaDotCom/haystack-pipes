...
public class ProtobufSpanMaskerToKafkaTransformerTest {
    ...
    public void testBuildStreamTopology() {
        ...
        when(mockSerdeFactory.createSpanProtoProtoSerde(anyString())).thenReturn(mockFromSpanSerde, mockToSpanSerde);
        ...
        verify(mockSerdeFactory, times(2)).createSpanProtoProtoSerde(APPLICATION);
