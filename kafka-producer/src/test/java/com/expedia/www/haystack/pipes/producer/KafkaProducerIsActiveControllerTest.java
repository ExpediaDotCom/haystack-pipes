...
import com.expedia.www.haystack.pipes.producer.Service.Factory;
...
import static com.expedia.www.haystack.pipes.producer.Service.STARTUP_MSG;
...
public class KafkaProducerIsActiveControllerTest {
    ...
    private void storeKafkaProducerIsActiveControllerWithMocksInStaticInstance() {
        new Service(mockProtobufToKafkaProducer, mockFactory, mockLogger);
    }
    ...
    public void testFactoryCreateSpringApplication() {
        ...
        assertSame(Service.class, objects[0]);
    }
}