...
public class SpringConfig {
    ...
    @Bean
    KafkaToKafkaPipeline.Factory produceIntoExternalKafkaActionFactory() {
    ...
    @Bean
    @Autowired
    KafkaToKafkaPipeline produceIntoExternalKafkaAction(
        ...
        return new KafkaToKafkaPipeline(
                ...
                timersAndCounters,
                kafkaToExternalKafkaActionLogger,
    ...
    ProtobufToKafkaProducer protobufToKafkaProducer(KafkaStreamStarter kafkaStreamStarter,
                                                    SerdeFactory serdeFactory,
                                                    KafkaToKafkaPipeline produceIntoExternalKafkaAction,
                                                    com.expedia.www.haystack.pipes.commons.kafka.KafkaConfigurationProvider kafkaConfigurationProvider) {
