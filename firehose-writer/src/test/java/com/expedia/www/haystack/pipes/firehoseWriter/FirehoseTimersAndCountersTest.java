...
public class FirehoseTimersAndCountersTest {
    ...
    private FirehoseTimersAndCounters firehoseTimersAndCounters;

    @Before
    public void setUp() {
        final Timers timers = new Timers(mockTimer, mockSpanArrivalTimer);
        firehoseTimersAndCounters = new FirehoseTimersAndCounters(mockClock, timers,
    ...
    public void testCountersCountSuccessesAndFailuresNullResult() {
        ...
        firehoseTimersAndCounters.countSuccessesAndFailures(mockRequest, null);
    ...
    public void testCountersCountSuccessesAndFailuresNonNullResult() {
        ...
        firehoseTimersAndCounters.countSuccessesAndFailures(mockRequest, mockResult);
    ...
    public void testCounterIncrementExceptionCounter() {
        firehoseTimersAndCounters.incrementExceptionCounter();
