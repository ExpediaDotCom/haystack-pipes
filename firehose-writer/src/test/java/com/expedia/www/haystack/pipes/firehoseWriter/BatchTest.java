...
public class BatchTest {
    ...
    private static final Map<String,String> CUSTOM_HEADERS = Collections.singletonMap(KEY, VALUE);
    ...
    public void testExtractFailedRecordsNonNullResultInternalFailure() {
        ...
        when(mockRequest.getCustomRequestHeaders()).thenReturn(CUSTOM_HEADERS);
        ...
        verify(mockLogger).error(String.format(INTERNAL_FAILURE_MSG, 1, RETRY_COUNT, CUSTOM_HEADERS));
