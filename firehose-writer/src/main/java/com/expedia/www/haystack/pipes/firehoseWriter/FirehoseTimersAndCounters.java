...
@Component
class FirehoseTimersAndCounters extends TimersAndCounters {
    ...
    @Autowired
    FirehoseTimersAndCounters(Clock clock,
                              Timers timers,
                              Counter spanCounter,
        ...
        super(clock, timers, spanCounter, successCounter, failureCounter, exceptionCounter, socketTimeoutCounter);
    }
